...
if __name__ == '__main__':
 try:
    ...
    fsql_mysql_tables='''SELECT table_name,table_path,err_ds,err_hour,table_info,person_in_charge,project,workflow,task,table_type,flag from sla_table where update_type='h';'''
