...
def get_table_length(ip,port,path,dsdate):
    url="http://{}:{}/webhdfs/v1{}?user.name=hive&op=GETCONTENTSUMMARY".format(ip,port,path)
...
if __name__ == '__main__':
    ...
    fsql='''SELECT * from upstream_dim_table_monitor_di where err_hour="{}";'''.format(now.hour)
